...
const AlertDialogFooter = ({
  ...
  <div
    className={cn(
      "flex flex-col-reverse gap-2 pt-1 sm:grid sm:grid-cols-2",
      className
    )}
    {...props}
  />
